...
for i in range(len(year_month)):
	for root, dirs, files in os.walk(f'/data1/StackOverflow/_Robustness/UserCluster/data_final/{year_month[i]}'): # parameter (change 'Final')
		folks = {}
		for folk in files:
	...
	# save via pickle
	with open(f'/data1/StackOverflow/_Robustness/UserCluster/result_pickle_final/{year_month[i]}.pickle', 'wb') as fw: # parameter (change 'Final_pickle')
		pickle.dump(df, fw)