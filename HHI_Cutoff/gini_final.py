...
for i in range(len(cutoff_List)):
    ...
    # Result Appending
    filename = f"/data1/StackOverflow/_Robustness/HHI_Cutoff/gini_pickle/entropy_{cutoff_List[i]}.pkl"
...
with open('/data1/StackOverflow/_Robustness/HHI_Cutoff/gini_pickle/result.pkl', 'wb') as file:
