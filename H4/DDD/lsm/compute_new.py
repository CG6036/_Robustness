...
for i in range(len(year_month)):
	for root, dirs, files in os.walk(f'/data1/StackOverflow/_Robustness/H4/DDD/lsm/lsm_data/newbie/{year_month[i]}'): # parameter (change 'Final')
		folks = {}
		for folk in files:
	...
	# save via pickle
	with open(f'/data1/StackOverflow/_Robustness/H4/DDD/lsm/lsm_result/newbie/{year_month[i]}.pickle', 'wb') as fw: # parameter (change 'Final_pickle')
		pickle.dump(df, fw)